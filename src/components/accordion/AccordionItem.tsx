        ...
        <div className={cn("overflow-hidden", props.className)}>
            <button
                ...
                className={cn(
                    ...
                    isActive ? "rounded-b-none to-primary" : "rounded-b"
                )}
            >
            ...
            <p
                className={cn(
                    "text-sm overflow-y-scroll transition-all duration-300 border-2 border-white border-t-0 rounded-b p-5",
                    isActive ? "py-5 h-36" : "py-0 h-0 border-b-0"
                )}
            >
                {children}
            </p>
